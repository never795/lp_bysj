/*banner*/
function bannerAllWidth(){
	var img_div = document.getElementsByClassName('img-div')[0];
	var img_count = img_div.childNodes.length;
	if(img_count<=1){
		img_div.style.width = 1180+'px';
	}else{
		img_div.style.width = 1180*img_count+'px';
	}
...
//			console.log(value);
	...
	play:function(){
		this.slide.timer = setInterval(function(){
			...
			zBase.animate(zBase.img_div,zBase.config.direct,-zBase.config.index*1180);
